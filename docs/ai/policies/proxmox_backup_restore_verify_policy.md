...
| 2026-08-02 | 本文に埋め込まれていた判断日付(BRV-011「Yoshinobuが判断済み(2026-07-06)」)を除去し、規則本文とBRV番号だけを残す整理を行った(`docs/ai/reviews/norm_docs_rationale_removal_round3/`)。許可・禁止・停止条件、BRV番号はいずれも変更していない。BRV番号の新設・退番はない |
