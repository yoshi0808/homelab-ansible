...
2. **自分のRole本文** — この対話セッションはCoordinatorなので [`docs/ai/roles/coordinator.md`](docs/ai/roles/coordinator.md)(着手前の報告の型、承認境界、`docs/ai/status.md`の維持はここにしか無い)
3. identity・Role・routingの正本 [`docs/ai/role-routing-index.md`](docs/ai/role-routing-index.md)
