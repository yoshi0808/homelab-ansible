...
# determination are all done in Ansible tasks — skills/ansible-implementation-style/SKILL.md / requirement §11).
...
# formatting only, no judgement — skills/ansible-implementation-style/SKILL.md):
#   Inst <pkg> [<oldver>] (<newver> <source> [...])
